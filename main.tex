...
\paragraph{Cog memory.} As depicted in \figref{MAYBE}, the machine code zone is part of the Cog memory, along with the heap and the stack. While regular objects are stored in the heap, the native functions stored in the machine code zone comes in many shapes : trampolines, PIC (closed and openPIC), cogMethod... \textbf{[à finir]}
